...
<div class="container">
  <div class="clone">
    <div class="alert alert-success">
      <strong>Your reference has been submitted.</strong><a href="success.php" class="alert-link"> CLICK HERE!</a> to complete the application process if you do not have another reference to add.
    </div>
    <div class="well">
      <div class="row">
  ...
  <div class="row well">
    ...
    <div class="col-xs-6">
      <a href="success.php" class="btn btn-block btn-success" role="button">Complete Application</a>
    </div>
  </div>  
</div>
