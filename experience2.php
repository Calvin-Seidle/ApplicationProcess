...
<div class="container">
  ...
  <div class="alert alert-success">
    <strong>Your Job Experience has been submitted.</strong><a href="references.php" class="alert-link"> CLICK HERE!</a> to continue with the application process if you do not have another job experience to add.
  </div>
  ...
  <div class="row well">
    ...
    <div class="col-xs-6">
      <a href="references.php" class="btn btn-block btn-success" role="button">Continue</a>
    </div>
  </div>
</div>
</form>   
